      ...
      <div className="flex flex-col md:flex-row items-center gap-10">
        ...
        <div className="space-y-2 flex-1 text-center md:text-left">
          ...
          <div className="text-[0.95rem] text-foreground/60 leading-relaxed">
            <p>
              Opa, eu sou o Matsu, trabalho com <strong className="text-white font-bold">edição de vídeo</strong> e <strong className="text-white font-bold">motion design</strong>. Sou especializado em <u>After Effects</u> e <u>Premiere Pro</u> há mais de <strong className="text-white font-bold">8 anos</strong>, começando na época de ouro das Intros.
            </p>
          </div>
