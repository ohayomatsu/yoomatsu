  ...
  return (
    <section id="portfolio" className="py-24 px-6 max-w-7xl mx-auto space-y-16 scroll-mt-20">
      ...
      <div className="w-full flex flex-col items-center justify-center space-y-12">
        <div 
          ref={containerRef}
          className="relative grid grid-cols-2 md:flex items-center justify-center p-2 md:p-1 bg-white/[0.04] border border-white/10 rounded-2xl md:rounded-full w-full max-w-md md:max-w-none mx-auto gap-1 md:gap-0"
        >
          {/* Liquid Slider Pill */}
          <div 
